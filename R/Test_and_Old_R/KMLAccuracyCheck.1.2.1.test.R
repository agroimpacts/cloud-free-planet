#! /usr/bin/R -f
##############################################################################################################
# Title      : KMLAccuracyCheck_1.2.1.test.R
...
#                      286PLSP75KLMCLHI0Z8QHQVJRSKZTB. Result too generous. Fix by making sure correct names are
#                      being referenced in call to accStatsSum. Lines 157-178
#                    Additions:
