...
UPDATE configuration SET value = 'We're sorry, but your accuracy score was too low (<0.6) to accept your results.' WHERE key = 'HitRejectDescription'
...
UPDATE configuration SET value = 'Congratulations! You have successfully completed all %(totCount)d training maps. Now please copy your Training ID<br/><b>%(trainingId)s</b><br/>into the qualification test window's answer field, and click 'Done'.<br/>You will receive an email confirmation that you have earned the Mapping Africa qualification shortly afterward.' WHERE key = 'QualTest_TF_TextEnd'
