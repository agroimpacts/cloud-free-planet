...
To select the date range, do the following: 
...
# rasterize and check
dry_wins_s <- dt_to_raster(dry_winsdtf2, CRSobj = proj4string(rfaf))
plot(dry_wins_s)
